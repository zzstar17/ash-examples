...
glslc -O .\src\render\shaders\shader.vert --target-env=vulkan1.3 -o .\shaders\vert_debug.spv -gVS
glslc -O .\src\render\shaders\shader.frag --target-env=vulkan1.3 -o .\shaders\frag_debug.spv -gVS
